...
The app can process multiple stock name entries and give user a binary feedback on whether to buy or not to buy the stock/stocks. Stock names must be separated by space. 
